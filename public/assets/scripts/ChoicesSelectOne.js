...
(function webpackUniversalModuleDefinition(root, factory) {
   ...
   //CommonJS
		...
		exports["ChoicesSelectOne"] = factory();
   //Window
	else
		root["ChoicesSelectOne"] = factory();
...
var _fuse = __webpack_require__(83);
...
var ChoicesSelect = function (_ChoicesCore) {
  _inherits(ChoicesSelect, _ChoicesCore);

  function ChoicesSelect(element, config) {
    _classCallCheck(this, ChoicesSelect);

    var _this = _possibleConstructorReturn(this, (ChoicesSelect.__proto__ || Object.getPrototypeOf(ChoicesSelect)).call(this, element, config));
    ...
    _this.passedElement = new _components.WrappedSelect({
      element: element,
    ...
    _this._currentValue = '';
    _this._canSearch = _this.config.searchEnabled;
    ...
    _this._presetChoices = _this.config.choices;
  ...
  _createClass(ChoicesSelect, [{
    ...
    value: function showDropdown(preventInputFocus) {
      ...
      requestAnimationFrame(function () {
        _this2.dropdown.show();
        _this2.containerOuter.open(_this2.dropdown.distanceFromTopWindow());

        if (!preventInputFocus && _this2._canSearch) {
          _this2.input.focus();
        }

        _this2.passedElement.triggerEvent(_constants.EVENTS.showDropdown, {});
      });
    ...
    value: function hideDropdown(preventInputBlur) {
      ...
      requestAnimationFrame(function () {
        ...
        _this3.containerOuter.close();

        if (!preventInputBlur && _this3._canSearch) {
          _this3.input.removeActiveDescendant();
          _this3.input.blur();
        }

        _this3.passedElement.triggerEvent(_constants.EVENTS.hideDropdown, {});
      });
    ...
    value: function setValue(args) {
      ...
      [].concat(_toConsumableArray(args)).forEach(function (value) {
        return _this4._setChoiceOrItem(value);
      });
      return this;
    }
  }, {
    ...
    value: function _highlightChoice() {
      ...
      highlightedChoices.forEach(function (choice) {
        choice.classList.remove(_this8.config.classNames.highlightedState);
    ...
    value: function _findAndSelectChoiceByValue(val) {
      ...
      var foundChoice = choices.find(function (choice) {
        return _this9.config.itemComparer(choice.value, val);
      });
    ...
    value: function _createItemsFragment(items) {
      ...
      var addItemToFragment = function addItemToFragment(item) {
        ...
        var listItem = _this13._getTemplate('item', item, removeItemButton);
        // Append it to list
    ...
    value: function ajax(fn) {
      ...
      requestAnimationFrame(function () {
        return _this15._handleLoadingState(true);
      });
...
var _choicesSelect = __webpack_require__(82);
  ...
  _createClass(ChoicesSelectOne, [{
    ...
    value: function _generateInstances(elements, config) {
      return elements.reduce(function (instances, element) {
        instances.push(new ChoicesSelectOne(element, config));
        return instances;
      }, [this]);
    }
  }, {
...
module.exports = ChoicesSelectOne;

/***/ })
/******/ ]);
});
//# sourceMappingURL=ChoicesSelectOne.js.map